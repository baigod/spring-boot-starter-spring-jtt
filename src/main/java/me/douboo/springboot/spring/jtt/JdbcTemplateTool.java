...
public class JdbcTemplateTool {
	...
	public void save(Object po) {
		...
		if (!"".equals(autoGeneratedColumnName)) {
			...
			SqlParamsPairs sqlAndParams = ModelSqlUtils.getInsertFromObject(po, null);
			getProxy().update(sqlAndParams.getSql(), sqlAndParams.getParams());
		}
	}
	...
	public long save(Object po, String autoGeneratedColumnName) {
		SqlParamsPairs sqlAndParams = ModelSqlUtils.getInsertFromObject(po, null);
		return getProxy().insert(sqlAndParams.getSql(), sqlAndParams.getParams(), autoGeneratedColumnName);
	}
	 ...
	 * @throws Exception
	 */
	public long save(Object po, String autoGeneratedColumnName, String tableName) {
		SqlParamsPairs sqlAndParams = ModelSqlUtils.getInsertFromObject(po, tableName);
		// 动态切换库名
	...
	public void setJdbcTemplate(JdbcTemplate jdbcTemplate) {
		...
		try {
			ModelSqlUtils.setDriver(DatabaseDriver.fromJdbcUrl(jdbcTemplate.getDataSource().getConnection().getMetaData().getURL()));
